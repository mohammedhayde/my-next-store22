...
const searchClient = algoliasearch(
  process.env.NEXT_PUBLIC_ALGOLIA_APP_ID ?? 'BHHXVEKGFH',
  process.env.NEXT_PUBLIC_ALGOLIA_PUBLIC_API_KEY ?? '59327a638018a363eace1923b8cb9c81',
);
...
const AlgoliaSearchBox = () => {
  ...
  return (
    <div className="hidden mt-2 md:inline xl:inline">
      <div className="">
        <InstantSearch
          indexName={process.env.NEXT_PUBLIC_ALGOLIA_INDEX_NAME ?? 'shopify_products'}
